        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-md text-sm text-white/70">
              Cocina tradicional francesa con ingredientes locales, ubicada a los pies del Castillo de San Juan de las Águilas. Una experiencia gastronómica única en Águilas, Murcia.
            </p>
            <div className="mt-6 flex gap-4">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/5 transition hover:border-yellow-500 hover:bg-yellow-500/10"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li className="flex items-start gap-2">
                ...
                <span>Castillo de San Juan<br />30880 Águilas, Murcia</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+34968123456" className="hover:text-yellow-500 transition">+34 968 12 34 56</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="h-5 w-5 shrink-0 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@elpiecastillo.com" className="hover:text-yellow-500 transition">info@elpiecastillo.com</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-white/10 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-white/50 md:flex-row">
            ...
            <div className="flex gap-6">
              <a href="#privacy" className="hover:text-yellow-500 transition">Política de Privacidad</a>
              <a href="#terms" className="hover:text-yellow-500 transition">Términos y Condiciones</a>
            </div>
          </div>
        </div>
      </div>
